...
require_relative 'lib/simple_site_crawler/version'

Gem::Specification.new do |spec|
  spec.name = 'simple_site_crawler'
  spec.version = SimpleSiteCrawler::VERSION
  spec.authors = ['Romiras']
  spec.email = ['298544+romiras@users.noreply.github.com']
